OPTIONAL_APPS=("1password" "Spotify" "Zoom" "Dropbox" "Keepasshc" "Teams" "Telegram" "Obs-studio" "Zoom")
DEFAULT_OPTIONAL_APPS='Dropbox,Zoom,Keepasshc,Teams,Telegram,Obs-studio,Zoom'
